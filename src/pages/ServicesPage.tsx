  ...
  return (
    <div className="w-full">
      ...
      <section className="bg-[#1a365d] text-white py-20">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl text-gray-200">
            Professional finance writing services that make complex topics accessible and engaging.
          </p>
        </div>
      </section>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-[#1a365d] mb-12 text-center">My Process</h2>
          <div className="relative max-w-4xl mx-auto">
            {/* Vertical Line */}
            <div className="hidden md:block absolute left-1/2 transform -translate-x-1/2 h-full w-1 bg-[#1a365d]" />

            <div className="space-y-12">
              {steps.map((step, index) => {
                const isLeft = index % 2 === 0;
                return (
                  <div key={step.step} className="relative flex flex-col md:flex-row items-center">
                    {/* Desktop Left */}
                    <div className={`hidden md:flex flex-1 ${isLeft ? 'justify-end pr-8 text-right' : 'pl-8 text-left'}`}>
                      {isLeft && (
                        <div>
                    ...
                    {/* Desktop Right */}
                    <div className={`hidden md:flex flex-1 ${!isLeft ? 'justify-start pl-8 text-left' : 'pr-8 text-right'}`}>
                      {!isLeft && (
                        <div>
                          <h3 className="text-xl font-bold text-[#1a365d]">{step.title}</h3>
                          <p className="text-gray-700 mt-2">{step.description}</p>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-[#1a365d] mb-12 text-center">Why Work With Me</h2>
      ...
      <section className="py-16 bg-[#1a365d] text-white text-center">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold mb-6">Let's Discuss Your Content Needs</h2>
          <p className="text-xl text-gray-200 mb-8 max-w-2xl mx-auto">
            Ready to create finance content that engages your audience and drives results?
          </p>
